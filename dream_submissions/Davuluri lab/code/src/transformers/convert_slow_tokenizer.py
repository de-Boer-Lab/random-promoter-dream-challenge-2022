...
from .file_utils import is_protobuf_available, is_sentencepiece_available
...
class DNAKmerConverter(Converter):
    def converted(self) -> Tokenizer:
        vocab = self.original_tokenizer.vocab
...
class DNASubConverter(SpmConverter):
    def vocab(self, proto):
        return [
...
SLOW_TO_FAST_CONVERTERS = {
    ...
    "DNAKmerTokenizer": DNAKmerConverter,
    "DNASubTokenizer": DNASubConverter,
