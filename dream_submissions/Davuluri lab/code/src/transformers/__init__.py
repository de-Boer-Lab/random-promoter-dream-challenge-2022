...
_import_structure = {
    ...
    "models.dna_kmer": [
        "DNA_KMER_PRETRAINED_CONFIG_ARCHIVE_MAP",
        "DNAKmerConfig",
        "DNAKmerTokenizer",
    ],
    "models.dna_sub": [
        "DNA_SUB_PRETRAINED_CONFIG_ARCHIVE_MAP",
        "DNASubConfig",
        "DNASubTokenizer",
    ],
    "models.dpr": [
...
if is_tokenizers_available():
    ...
    _import_structure["models.dna_kmer"].append("DNAKmerTokenizerFast")
    _import_structure["models.dna_sub"].append("DNASubTokenizerFast")
...
if is_torch_available():
    ...
    # _import_structure["models.dna"].extend(
    #     [
    #         "DNA_PRETRAINED_MODEL_ARCHIVE_LIST",
...
if TYPE_CHECKING:
    ...
    from .models.dna_kmer import (
        DNA_KMER_PRETRAINED_CONFIG_ARCHIVE_MAP,
        DNAKmerConfig,
        DNAKmerTokenizer,
    )
    from .models.dna_sub import (
        DNA_SUB_PRETRAINED_CONFIG_ARCHIVE_MAP,
        DNASubConfig,
        DNASubTokenizer,
    )
    ...
    if is_tokenizers_available():
        ...
        from .models.dna_kmer import DNAKmerTokenizerFast
        from .models.dna_sub import DNASubTokenizerFast
