...
import chrombpnet.training.models.dream_cnn_with_bias_model as dream_cnn_with_bias_model

from chrombpnet.training.train_modified import *
args_copy = copy.deepcopy(args)

if args_copy.architecture_from_file is None:
    args_copy.architecture_from_file = 	dream_cnn_with_bias_model.__file__
